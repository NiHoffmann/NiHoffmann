...
- 🛠️ **Currently at Fraunhofer FKIE** - Sole owner of a **mobile sensor platform**, redesigned from the ground up to replace a Raspberry Pi-based predecessor.
  ...
  - **~120 µA deep sleep** (RTC-gated) / **~400 µA light sleep** (accelerometer-gated) at 12 V via split power domains and tickless FreeRTOS scheduling across active and idle modes
