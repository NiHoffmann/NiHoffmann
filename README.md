...
- 🛠️ **Currently at Fraunhofer FKIE** - Sole owner of a **mobile sensor platform**, redesigned from the ground up to replace a Raspberry Pi-based predecessor.
  ...
  - **~5-6x better energy efficiency** across the full field duty cycle (remaining draw dominated by GPS and modem base current)
  - **~120 µA deep sleep** (RTC-gated) / **~400 µA idle mode** (accelerometer-gated) at **12 V** for the entire device via split power domains and tickless FreeRTOS scheduling across active and idle modes
