...
- 🐍 Proud of my **MicroPython C-API port for the Open Robotic Board (ORB-Project)** - full native integration of MicroPython into STM32 firmware, exposing motor/sensor control to Python through custom C bindings. Robots running this port were **demonstrated at Gamescom** as part of my university's public exhibit. MicroPython is now listed as an official programming option (alongside C++) for the ORB platform, used in embedded systems and robotics courses at H-BRS.
