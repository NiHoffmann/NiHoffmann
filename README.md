...
- 🐍 Proud of my **MicroPython C-API port (ORB - Project) for the Open Robotic Board**  - full native integration of MicroPython into STM32 firmware, exposing motor/sensor control to Python through custom C bindings
---
